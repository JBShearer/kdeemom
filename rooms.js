...
function paintKids(c){
  ...
  // Greyson's room door — back wall right side, between poster and desk
  D(c,252,115,80,105,P.dbrown);RR(c,255,118,74,99,4,"#4a2a10");
  c.fillStyle="rgba(20,10,5,0.25)";c.fillRect(256,119,72,97);
  c.fillStyle="#888";c.beginPath();c.arc(316,185,3,0,Math.PI*2);c.fill();
  c.fillStyle="rgba(255,215,0,0.55)";c.font="bold 5px monospace";c.textAlign="center";c.fillText("GREYSON",292,150);c.textAlign="left";
  // Mr. Rex
